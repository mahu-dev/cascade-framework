...
public class TokenBucketRateLimiter extends AbstractRateLimiter {
    ...
    private static final Duration RATE_INTERVAL = Duration.ofSeconds(1);
    private static final long RATE_INTERVAL_MS = RATE_INTERVAL.toMillis();
    ...
    public boolean acquire(String key, RateLimitStrategy strategy, long timeoutMs) throws InterruptedException {
        ...
        return limiter.tryAcquire(1, Duration.ofMillis(timeoutMs));
    }
