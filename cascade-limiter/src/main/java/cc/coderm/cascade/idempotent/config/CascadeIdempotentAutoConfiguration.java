...
public class CascadeIdempotentAutoConfiguration {
    ...
    static class ServletHeaderResolverConfiguration {
        @Bean
        @ConditionalOnMissingBean
        IdempotentHeaderResolver idempotentHeaderResolver(ObjectProvider<HttpServletRequest> requestProvider) {
            return new ServletRequestIdempotentHeaderResolver(requestProvider);
        }
    }
